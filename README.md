...
This project analyzes customer data from Thera Bank to uncover insights that can help improve the success rate of personal loan marketing campaigns. With only 9.6% of 5,000 customers having accepted personal loan offers in the past, the objective is to identify key customer segments and behaviors that could inform more targeted and effective marketing strategies.
...
Account Details: Securities account, CD account, credit card usage

Campaign Response: Whether the customer accepted the personal loan offer

Only 480 customers (9.6%) accepted the personal loan offer in the previous campaign, highlighting the need for refined targeting strategies.
...
Data-driven customer segmentation can significantly improve the success of Thera Bank’s personal loan campaigns. By understanding the demographics and financial behavior of customers, the bank can design personalized offers that are more likely to be accepted, thereby increasing loan adoption while keeping acquisition costs low.
